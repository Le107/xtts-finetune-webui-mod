...
8. Создание датасета по субтитрам. (см. в finetune_models). Когда нарезается датасет по субтитрам создается файл `Dialogs.txt`, в котором сохраняется `имя_аудиофайла_датасета`=`текст_из_субтитров`.
